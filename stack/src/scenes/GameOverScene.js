class GameOverScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    const best = data.best || parseInt(localStorage.getItem('stack_best') || '0');
    ...
    this.add.text(W / 2, H * 0.38 + 22, score.toString(), {
      fontSize: '64px',
      fontFamily: 'Arial Black, Arial',
      color: '#ffffff'
    }).setOrigin(0.5);
    ...
    if (isNewBest && score > 0) {
      const newBestTxt = this.add.text(W / 2, H * 0.38 + 90, 'NEW BEST', {
        fontSize: '13px',
        fontFamily: 'Arial',
        color: '#00cfff',
        letterSpacing: 4
      ...
      this.add.text(W / 2, H * 0.38 + 86, 'BEST  ' + best, {
        fontSize: '14px',
        fontFamily: 'Arial',
        color: '#334455',
        letterSpacing: 2
